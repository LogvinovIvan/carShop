            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <c:forEach  var="testDrive" items="${testDriveList}">
                        <tr>
                            <td>${testDrive.id}</td>
                            <td><c:out value="${testDrive.idClient}" /></td>
                            <td><c:out value="${testDrive.mark}" /></td>
                            <td><c:out value="${testDrive.model}" /></td>
                            <td><c:out value="${testDrive.date}" /></td>
                        </tr>
                    </c:forEach>
                        ...
                        <form action="testDrive" class="form" method="post" name="form">
                            <div class="modal-body">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <input type="text" name="id" placeholder="idWorkerOnDelete" required>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="modal-body">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <input type="text" name="idClient" placeholder="Ivan" required/>
                                    <li>
