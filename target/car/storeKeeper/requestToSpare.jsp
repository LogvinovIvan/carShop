        ...
        <form action="goTo" method="get">
            ...
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    <li><a href="/redirect?page=storeKeeper_storeKeeper">Spare Part</a></li>
                    <li><a href="/redirect?page=storeKeeper_requestToSparePart" name="technicalService">Request to spare</a></li>
                </ul>
            </div>
        </form>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="table-responsive">
                <table class="table table-striped">
                    ...
                    <tbody>
                    <c:forEach  var="spare" items="${spareList}">
                        <tr>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="spares" class="form" method="post" name="form">
                            <div class="modal-body">
                                <input type="hidden" name="request" value="delete_request"/>
                                <ul>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form" action="spares" method="post" name="form">
                            <div class="modal-body">
                                <input type="hidden" name="request" value="add_request"/>
                                <ul>
            ...
            <div class="modal fade update">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form class="form" action="spares" method="post" name="form">
                            <div class="modal-body">
                                <input type="hidden" name="request" value="update_request"/>
                                <ul>
                                    <li><h2>Add worker</h2></li>
                                    <li>
                                        <label for="idMechanic">idMechanic:</label>
